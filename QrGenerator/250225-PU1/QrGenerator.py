#!/usr/bin/env python
# -*- coding: utf-8 -*-
# 基于 230302-2-PU1 版修改，KBSPEC6=PERKEY-RGB时，显示Y
# 20250224 =================================================
# 增加 Y logo RGB 项目，ylogorgb
# ==========================================================
# 20230302 =================================================
# 1. 当 KBSPEC2 = BL 时，KBSPEC2 = Y，否则为 N
# 2. 当 KBSPEC4 包含 RGB 时，（KBSPEC2 = N，KBSPEC4 = Y），否则 KBSPEC4 = N
# ==========================================================
import os
import qrcode
...
if os.path.exists(bompath):
    with open(bompath,'r',encoding='utf-8') as file:
        ...
        for line in file.readlines():
            ...
            # Y logo RGB -- 20250224
            if 'ylogorgb' in valist:
                if ylogorgb+'=' in line:
                    yrgb = line.split('=')[1].replace('\n','').strip()
                    if yrgb == 'PERKEY-RGB':
                        replace_dict['ylogorgb'] = 'Y'
                    else:
                        replace_dict['ylogorgb'] = 'N'
            ...
            if 'kbblkey' in valist:
                if kbblkey+'=' in line:
                    ...
                    if kbbl == 'BL' and replace_dict['rgbkb'] == 'N':
